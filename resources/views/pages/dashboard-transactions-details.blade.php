                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    <div class="row">
                      ...
                      <div class="col-12 col-md-6">
                        <div class="product-title">Alamat Patokan</div>
                        <div class="product-subtitle">
                      ...
                      <div class="col-12 col-md-6">
                        <div class="product-title">Desa/Kelurahan</div>
                        <div class="product-subtitle">
                          {{ App\Models\Regency::find($transaction->transaction->user->provinces_id)->name }}
                        </div>
                      </div>
                      <!-- <div class="col-12 col-md-6">
